...
- **项目定位**：专利估值、质押、放款与风险监控一体化平台
- **核心差异点**：整合 1 大业务实体（质押案件），提供全流程数字化管理
- **关键功能**：浏览pledge-case、查看pledge-case详情、新增/编辑pledge-case
...
| 字段 | 内容 |
|------|------|
| 项目名称 | 知识产权金融一体化智能评估质押系统 |
| 产品愿景 | 专利估值、质押、放款与风险监控一体化平台 |
| 所属领域 | PATENT |
...
| 维度 | 内容 |
|------|------|
| 产品名称 | 知识产权金融一体化智能评估质押系统 |
| 产品描述 | 专利估值、质押、放款与风险监控一体化平台 |
| 所属领域 | PATENT |
| 实体数量 | 1 个 |
| 角色数量 | 3 个 |
| 页面数量 | 3 个 |
...
| ID | 名称 | 字段数 | 状态数 |
|------|------|--------|--------|
| pledge-case | 质押案件 | 7 | 6 |

### 角色清单

| ID | 名称 | 权限数 |
|------|------|--------|
| financing-manager | 企业融资经理 | 1 |
| bank-risk | 银行风控 | 1 |
| assessor | 评估师 | 1 |
...
| ID | 页面名称 | 类型 | 关联实体 | 路由 |
|------|---------|------|---------|------|
| P01 | pledge-case-list | CRUD 列表页 | pledge-case | /pledge-cases |
| P02 | pledge-case-detail | 详情页 | pledge-case | /pledge-cases/:id |
| P03 | pledge-case-apply | 表单页 | pledge-case | /pledge-cases/form |


---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:18:59.193Z）
