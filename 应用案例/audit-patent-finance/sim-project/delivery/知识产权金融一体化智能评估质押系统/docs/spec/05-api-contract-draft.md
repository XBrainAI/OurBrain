...
### 3.1 质押案件 (pledge-case)

#### pledge-case-01 列表查询

- **Method**: GET
- **URL**: /api/pledge-cases
- **Query**: page, size, sort, keyword, case_no
- **Response**: `{ list: pledge-case[], total, page, size }`

#### pledge-case-02 详情查询

- **Method**: GET
- **URL**: /api/pledge-cases/{id}
- **Response**: pledge-case 对象

#### pledge-case-03 新增

- **Method**: POST
- **URL**: /api/pledge-cases
- **Body**: pledge-case 对象（不含 id）
- **Response**: `{ id: string }`
...
- **Method**: POST
- **URL**: /api/pledge-cases/{id}/transition
...
Mock 数据需覆盖：质押案件 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:18:59.239Z）
