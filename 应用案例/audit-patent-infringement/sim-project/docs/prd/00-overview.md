...
- **项目定位**：多渠道侵权监测、区块链存证与维权处置平台
- **核心差异点**：整合 1 大业务实体（侵权案件），提供全流程数字化管理
- **关键功能**：浏览infringement-case、查看infringement-case详情、新增/编辑infringement-case
...
| 字段 | 内容 |
|------|------|
| 项目名称 | 线上AI智能侵权监测与快速维权取证系统 |
| 产品愿景 | 多渠道侵权监测、区块链存证与维权处置平台 |
| 所属领域 | PATENT |
...
| 维度 | 内容 |
|------|------|
| 产品名称 | 线上AI智能侵权监测与快速维权取证系统 |
| 产品描述 | 多渠道侵权监测、区块链存证与维权处置平台 |
| 所属领域 | PATENT |
| 实体数量 | 1 个 |
| 角色数量 | 3 个 |
| 页面数量 | 3 个 |
...
| brand-ipr | 品牌方IPR | 1 |
| lawyer | 维权律师 | 1 |
| monitor-analyst | 监测分析师 | 1 |

### 页面清单

| ID | 页面名称 | 类型 | 关联实体 | 路由 |
|------|---------|------|---------|------|
| P01 | infringement-case-list | CRUD 列表页 | infringement-case | /infringement-cases |
| P02 | infringement-case-detail | 详情页 | infringement-case | /infringement-cases/:id |
| P03 | infringement-monitor-form | 表单页 | infringement-case | /infringement-cases/form |


---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:19:16.069Z）
