...
| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无估值记录数据" | [新增估值记录] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |
...
| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无年费记录数据" | [新增年费记录] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |
...
| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无质押登记数据" | [新增质押登记] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |
...
| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无专利组合数据" | [新增专利组合] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |
...
| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无撮合需求数据" | [新增撮合需求] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |

#### P08 executive-cockpit
...
> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-08-30T00:54:23.758Z）
