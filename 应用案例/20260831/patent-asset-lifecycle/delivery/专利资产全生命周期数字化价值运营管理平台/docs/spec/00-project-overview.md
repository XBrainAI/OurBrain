...
基于需求模型中的 7 个业务实体，系统划分为以下模块：

| 模块 | 核心实体 | 职责 |
|------|---------|------|
| Patent管理 | 专利资产 | 专利资产数据的增删改查、状态流转、权限控制 |
| Valuation管理 | 估值记录 | 估值记录数据的增删改查、状态流转、权限控制 |
| AnnualFee管理 | 年费记录 | 年费记录数据的增删改查、状态流转、权限控制 |
| Pledge管理 | 质押登记 | 质押登记数据的增删改查、状态流转、权限控制 |
| TransferRequest管理 | 转让请求 | 转让请求数据的增删改查、状态流转、权限控制 |
| Portfolio管理 | 专利组合 | 专利组合数据的增删改查、状态流转、权限控制 |
| MatchDemand管理 | 撮合需求 | 撮合需求数据的增删改查、状态流转、权限控制 |
...
> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-08-30T00:54:23.743Z）
