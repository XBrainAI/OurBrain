...
### 3.1 绿色专利 (green-patent)

#### green-patent-01 列表查询

- **Method**: GET
- **URL**: /api/green-patents
- **Query**: page, size, sort, keyword, patent_no
- **Response**: `{ list: green-patent[], total, page, size }`

#### green-patent-02 详情查询

- **Method**: GET
- **URL**: /api/green-patents/{id}
- **Response**: green-patent 对象

#### green-patent-03 新增

- **Method**: POST
- **URL**: /api/green-patents
- **Body**: green-patent 对象（不含 id）
- **Response**: `{ id: string }`
...
#### green-patent-06 状态转换

- **Method**: POST
- **URL**: /api/green-patents/{id}/transition
...
Mock 数据需覆盖：绿色专利 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:57:34.145Z）
