...
- **项目定位**：双碳赛道专利布局分析与情报监测平台
- **核心差异点**：整合 1 大业务实体（绿色专利），提供全流程数字化管理
- **关键功能**：浏览green-patent、查看green-patent详情、新增/编辑green-patent
...
| 字段 | 内容 |
|------|------|
| 项目名称 | 绿色低碳新质产业专项专利布局分析平台 |
| 产品愿景 | 双碳赛道专利布局分析与情报监测平台 |
| 所属领域 | PATENT |
...
| 维度 | 内容 |
|------|------|
| 产品名称 | 绿色低碳新质产业专项专利布局分析平台 |
| 产品描述 | 双碳赛道专利布局分析与情报监测平台 |
| 所属领域 | PATENT |
| 实体数量 | 1 个 |
| 角色数量 | 3 个 |
| 页面数量 | 3 个 |
...
|------|------|--------|
| ipr | 企业IPR | 1 |
| green-researcher | 绿色技术研究员 | 1 |
| layout-planner | 布局规划师 | 1 |

### 页面清单

| ID | 页面名称 | 类型 | 关联实体 | 路由 |
|------|---------|------|---------|------|
| P01 | green-patent-list | CRUD 列表页 | green-patent | /green-patents |
| P02 | green-patent-detail | 详情页 | green-patent | /green-patents/:id |
| P03 | green-patent-layout | 表单页 | green-patent | /green-patents/form |


---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:57:34.072Z）
