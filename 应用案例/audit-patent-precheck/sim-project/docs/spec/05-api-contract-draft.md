...
### 3.1 预审案件 (precheck-case)

#### precheck-case-01 列表查询

- **Method**: GET
- **URL**: /api/precheck-cases
- **Query**: page, size, sort, keyword, case_no
- **Response**: `{ list: precheck-case[], total, page, size }`

#### precheck-case-02 详情查询

- **Method**: GET
- **URL**: /api/precheck-cases/{id}
- **Response**: precheck-case 对象

#### precheck-case-03 新增

- **Method**: POST
- **URL**: /api/precheck-cases
- **Body**: precheck-case 对象（不含 id）
- **Response**: `{ id: string }`
...
#### precheck-case-06 状态转换

- **Method**: POST
- **URL**: /api/precheck-cases/{id}/transition
...
Mock 数据需覆盖：预审案件 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:57:00.902Z）
