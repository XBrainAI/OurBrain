...
- **项目定位**：专利预审案件全流程管理与智能预检平台
- **核心差异点**：整合 1 大业务实体（预审案件），提供全流程数字化管理
- **关键功能**：浏览precheck-case、查看precheck-case详情、新增/编辑precheck-case
...
| ID | 页面名称 | 类型 | 关联实体 | 路由 |
|------|---------|------|---------|------|
| P01 | precheck-case-list | CRUD 列表页 | precheck-case | /precheck-cases |
| P02 | precheck-case-detail | 详情页 | precheck-case | /precheck-cases/:id |
| P03 | precheck-case-submit | 表单页 | precheck-case | /precheck-cases/form |


---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:57:00.829Z）
