...
### 3.1 专利资产 (patent-asset)

#### patent-asset-01 列表查询

- **Method**: GET
- **URL**: /api/patent-assets
- **Query**: page, size, sort, keyword, patent_no
- **Response**: `{ list: patent-asset[], total, page, size }`

#### patent-asset-02 详情查询

- **Method**: GET
- **URL**: /api/patent-assets/{id}
- **Response**: patent-asset 对象

#### patent-asset-03 新增

- **Method**: POST
- **URL**: /api/patent-assets
- **Body**: patent-asset 对象（不含 id）
- **Response**: `{ id: string }`
...
#### patent-asset-06 状态转换

- **Method**: POST
- **URL**: /api/patent-assets/{id}/transition
...
Mock 数据需覆盖：专利资产 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:12:23.243Z）
