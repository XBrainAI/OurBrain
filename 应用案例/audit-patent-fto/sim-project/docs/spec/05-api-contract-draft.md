...
### 3.1 FTO分析 (fto-analysis)

#### fto-analysis-01 列表查询

- **Method**: GET
- **URL**: /api/fto-analysiss
- **Query**: page, size, sort, keyword, product_name
- **Response**: `{ list: fto-analysis[], total, page, size }`

#### fto-analysis-02 详情查询

- **Method**: GET
- **URL**: /api/fto-analysiss/{id}
- **Response**: fto-analysis 对象

#### fto-analysis-03 新增

- **Method**: POST
- **URL**: /api/fto-analysiss
- **Body**: fto-analysis 对象（不含 id）
- **Response**: `{ id: string }`
...
#### fto-analysis-06 状态转换

- **Method**: POST
- **URL**: /api/fto-analysiss/{id}/transition
...
Mock 数据需覆盖：FTO分析 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:56:45.730Z）
