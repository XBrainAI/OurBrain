...
### 3.1 专利创意 (patent-idea)

#### patent-idea-01 列表查询

- **Method**: GET
- **URL**: /api/patent-ideas
- **Query**: page, size, sort, keyword, title
- **Response**: `{ list: patent-idea[], total, page, size }`

#### patent-idea-02 详情查询

- **Method**: GET
- **URL**: /api/patent-ideas/{id}
- **Response**: patent-idea 对象

#### patent-idea-03 新增

- **Method**: POST
- **URL**: /api/patent-ideas
- **Body**: patent-idea 对象（不含 id）
- **Response**: `{ id: string }`
...
- **Method**: POST
- **URL**: /api/patent-ideas/{id}/transition
...
Mock 数据需覆盖：专利创意 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:56:38.146Z）
