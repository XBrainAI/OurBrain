...
- **项目定位**：面向垂直行业的专利创意培育与高价值布局平台
- **核心差异点**：整合 1 大业务实体（专利创意），提供全流程数字化管理
- **关键功能**：浏览patent-idea、查看patent-idea详情、新增/编辑patent-idea
...
| 字段 | 内容 |
|------|------|
| 项目名称 | 垂直行业AI高价值专利智能培育平台 |
| 产品愿景 | 面向垂直行业的专利创意培育与高价值布局平台 |
| 所属领域 | PATENT |
...
| 维度 | 内容 |
|------|------|
| 产品名称 | 垂直行业AI高价值专利智能培育平台 |
| 产品描述 | 面向垂直行业的专利创意培育与高价值布局平台 |
| 所属领域 | PATENT |
| 实体数量 | 1 个 |
| 角色数量 | 3 个 |
| 页面数量 | 3 个 |
...
| ID | 页面名称 | 类型 | 关联实体 | 路由 |
|------|---------|------|---------|------|
| P01 | patent-idea-list | CRUD 列表页 | patent-idea | /patent-ideas |
| P02 | patent-idea-detail | 详情页 | patent-idea | /patent-ideas/:id |
| P03 | patent-idea-form | 表单页 | patent-idea | /patent-ideas/form |


---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:56:38.044Z）
