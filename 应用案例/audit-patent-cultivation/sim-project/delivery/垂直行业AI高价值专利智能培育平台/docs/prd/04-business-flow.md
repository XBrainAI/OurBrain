...
flowchart TD
    ...
    subgraph Pool3["研发工程师"]
        Pool3_T1("执行业务操作")
    end
    Start --> Pool1_T1
    Pool1_Done -.->|交付专利创意| Pool2_T1
    Pool2_Done -.->|交付专利创意| Pool3_T1
    Pool3_Done --> End((业务完成))
```
...
|------|------|----------|----------|---------|--------|
| 企业IPR | 浏览专利创意 | 登录后进入工作台 | 专利创意列表页(patent-idea-list) | 专利创意 | 业务数据 |
| 代理师 | 执行业务操作 | 登录后进入工作台 | - | 专利创意 | 业务数据 |
| 研发工程师 | 执行业务操作 | 登录后进入工作台 | - | 专利创意 | 业务数据 |
...
```mermaid
flowchart LR
    System((本系统<br/>垂直行业AI高价值专利智能培育平台))
    Ext1["企业IPR"]
    Ext2["代理师"]
    Ext3["研发工程师"]
    Ext1 -->|专利创意数据| System
...
```mermaid
flowchart LR
    DS1[["专利创意<br/>字段: title, industry, innovation_point, proposer..."]]
    P1("新增创意<br/>(专利创意)")
    P2("查看创意<br/>(专利创意)")
    P3("标记推荐培育<br/>(专利创意)")
    P4("归档<br/>(专利创意)")
...
|------|------------|----------|----------|----------|---------|---------|
| 专利创意 | 企业IPR | 企业IPR/代理师/研发工程师 | 企业IPR/代理师/研发工程师 | 企业IPR → [专利创意] → 企业IPR | id | title, industry, innovation_point |
...
flowchart TD
    Start((用户登录))
    P01["专利创意列表页(patent-idea-list)<br/>/patent-ideas"]
    P02["专利创意详情页(patent-idea-detail)<br/>/patent-ideas/:id"]
    P03["专利创意表单页(patent-idea-form)<br/>/patent-ideas/form"]
    Start --> P01
    P01 --> P01_D{"用户操作?"}
    P01_D -->|查看详情| P02
    P01_D -->|新建| P03
...
|--------|----------|----------|------|----------|---------|
| 登录页 | 专利创意列表页(patent-idea-list) | 用户登录成功 | userId | 已认证 | 路由跳转 |
| 专利创意列表页(patent-idea-list) | 专利创意详情页(patent-idea-detail) | 点击新增按钮 | patent-idea | 已认证 | 路由跳转 |
| 专利创意详情页(patent-idea-detail) | 专利创意表单页(patent-idea-form) | 点击"推荐培育"按钮 | patent-idea | 已认证 | 路由跳转 |
| 专利创意表单页(patent-idea-form) | 专利创意列表页(patent-idea-list) | 点击返回/面包屑 | - | 已认证 | 返回 |
...
> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T09:56:38.079Z）
