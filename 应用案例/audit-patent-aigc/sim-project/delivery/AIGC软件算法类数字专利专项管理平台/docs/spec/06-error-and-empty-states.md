...
#### P01 aigc-patent-list

| 场景 | 展示内容 | 操作 |
|------|---------|------|
| 首次进入无数据 | 空状态图 + "暂无AIGC专利数据" | [新增AIGC专利] 按钮 |
| 搜索无结果 | 空状态图 + "未找到匹配数据" | [重置搜索] 按钮 |
| 筛选无结果 | 空状态图 + "当前筛选条件下无数据" | [清空筛选] 按钮 |

#### P02 aigc-patent-detail
...
> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:20:38.280Z）
