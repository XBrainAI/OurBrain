...
### 3.1 AIGC专利 (aigc-patent)

#### aigc-patent-01 列表查询

- **Method**: GET
- **URL**: /api/aigc-patents
- **Query**: page, size, sort, keyword, patent_no
- **Response**: `{ list: aigc-patent[], total, page, size }`

#### aigc-patent-02 详情查询

- **Method**: GET
- **URL**: /api/aigc-patents/{id}
- **Response**: aigc-patent 对象

#### aigc-patent-03 新增

- **Method**: POST
- **URL**: /api/aigc-patents
- **Body**: aigc-patent 对象（不含 id）
- **Response**: `{ id: string }`
...
- **Method**: POST
- **URL**: /api/aigc-patents/{id}/transition
...
Mock 数据需覆盖：AIGC专利 等 1 个实体的列表/详情/新增/编辑/删除场景。



---

> 本文档由 generate-prd.mjs (v5.2.2) 基于 requirement-model.yaml 自动生成（2026-07-21T10:20:38.278Z）
